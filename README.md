...
About the manual: It is an exe file ans it is available in seven languages (Wii compatible languages + the rest): English, Spanish, French, German, Dutch, Italian and Portuguese. The other languages still have the vWii interface that also has bugs. This will be fixed in the future when I will do the rest of the languages. It works with all the types of Wii, also with Dolphin emulator. You can also delete it if you want from Wii options and then going to channels. It is 297 blocks. Don't worry if you have a vWii or a Wii mini, or if you have another Wii Manual on your Wii. This channel has a unique ID, that is HCAA, so when you install it it's different from the other versions.
